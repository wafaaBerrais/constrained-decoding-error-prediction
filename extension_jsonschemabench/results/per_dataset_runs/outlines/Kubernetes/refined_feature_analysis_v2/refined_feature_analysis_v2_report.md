...
- OVER rate among valid tests: 0.1518
...
- `instance_has_unmatched_keys=true`: rate=1.000, lift=6.59, valid_tests=81, schemas=73.
- `additionalProperties_value=absent`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `instance_matching_pattern_keys_count=0`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `patternProperties_has_additionalProperties=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `patternProperties_regex_has_alternation=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `patternProperties_regex_has_anchor=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `patternProperties_regex_has_charclass=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `patternProperties_regex_has_dotstar=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
...
- `combinator_branch_count_bucket=0`: rate=0.152, lift=1.00, valid_tests=1280, schemas=775.
- `combinator_type=absent`: rate=0.152, lift=1.00, valid_tests=1280, schemas=775.
- `allOf_satisfied_branch_count_bucket=0`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `allOf_satisfied_branch_ratio=absent`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `anyOf_satisfied_branch_count=0`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `anyOf_satisfied_branch_count_bucket=0`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `branches_conflicting_types=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
- `branches_have_enum=false`: rate=0.152, lift=1.00, valid_tests=1680, schemas=1014.
...
OVER comparison:
- `instance_has_unmatched_keys=true`: test lift 6.59; schema lift 3.35; schemas 123.
- `combinator_branch_count_bucket=0`: test lift 1.00; schema lift 1.04; schemas 775.
- `combinator_type=absent`: test lift 1.00; schema lift 1.04; schemas 775.
