# Statistical study: Kubernetes / outlines
...
| coverage rate | 100.0% |
| accuracy on completed tests | 94.4% |
| under-constraint rate | 0.0% |
| over-constraint rate | 15.2% |
| median compile_grammar_s | 1.73 |
| p95 compile_grammar_s | 76.9 |
| max compile_grammar_s | 239 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| completed | compile_grammar_s | 1014 | 18.7 | 34.6 | 1.73 | 76.9 |
| completed | validation_loop_mean_s | 988 | 0.132 | 0.487 | 0.0716 | 0.399 |
| completed | compute_mask_mean_s | 988 | 0.0613 | 0.226 | 0.0335 | 0.185 |
| completed | commit_token_mean_s | 988 | 0.07 | 0.257 | 0.0381 | 0.213 |
...
| `has_enum` | 250 | 0.0% | 26.5% | 90.8% |
| `has_additionalProperties` | 408 | 0.0% | 24.4% | 91.1% |
| `many_properties` | 464 | 0.0% | 23.5% | 91.1% |
| `many_required` | 360 | 0.0% | 22.6% | 91.5% |
| `has_items` | 601 | 0.0% | 19.1% | 93.0% |
| `has_defs` | 731 | 0.0% | 18.6% | 93.0% |
| `has_ref` | 731 | 0.0% | 18.6% | 93.0% |
| `has_required` | 807 | 0.0% | 17.2% | 93.6% |
| `has_properties` | 1010 | 0.0% | 15.2% | 94.4% |

## Simple feature pairs

| feature_pair | schemas | timeout_rate | under_rate | over_rate |
| --- | ---: | ---: | ---: | ---: |
| `has_properties__AND__has_type` | 1010 | 0.0% | 0.0% | 15.2% |
| `has_properties__AND__has_required` | 807 | 0.0% | 0.0% | 17.2% |
| `has_required__AND__has_type` | 807 | 0.0% | 0.0% | 17.2% |
| `has_defs__AND__has_properties` | 731 | 0.0% | 0.0% | 18.6% |
| `has_defs__AND__has_ref` | 731 | 0.0% | 0.0% | 18.6% |
| `has_defs__AND__has_type` | 731 | 0.0% | 0.0% | 18.6% |
| `has_properties__AND__has_ref` | 731 | 0.0% | 0.0% | 18.6% |
| `has_ref__AND__has_type` | 731 | 0.0% | 0.0% | 18.6% |
| `has_defs__AND__has_required` | 636 | 0.0% | 0.0% | 19.5% |
| `has_ref__AND__has_required` | 636 | 0.0% | 0.0% | 19.5% |
...
| `has_defs__AND__has_properties` | 731 | 1 | 1e+06 | 0.0% | 0.0% | 90.6% |
| `has_defs__AND__has_ref` | 731 | 1 | 1e+06 | 0.0% | 0.0% | 90.6% |
| `has_defs__AND__has_type` | 731 | 1 | 1e+06 | 0.0% | 0.0% | 90.6% |
| `has_properties__AND__has_ref` | 731 | 1 | 1e+06 | 0.0% | 0.0% | 90.6% |
| `has_ref__AND__has_type` | 731 | 1 | 1e+06 | 0.0% | 0.0% | 90.6% |
| `has_additionalProperties__AND__has_items` | 385 | 1 | 1e+06 | 0.0% | 0.0% | 65.3% |
| `has_additionalProperties__AND__has_defs` | 402 | 1 | 1e+06 | 0.0% | 0.0% | 66.8% |
| `has_additionalProperties__AND__has_ref` | 402 | 1 | 1e+06 | 0.0% | 0.0% | 66.8% |
| `has_additionalProperties__AND__has_properties` | 408 | 1 | 1e+06 | 0.0% | 0.0% | 66.8% |

## Very slow completed schemas and errors

| group | schemas | compile_min_s | compile_max_s | under_rate | over_rate | accuracy |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| fast | 254 | 0.0507 | 0.718 | 0.0% | 16.9% | 93.6% |
| medium | 253 | 0.719 | 1.73 | 0.0% | 4.7% | 98.3% |
| slow | 253 | 1.74 | 29.4 | 0.0% | 13.0% | 95.4% |
| very_slow | 254 | 29.4 | 239 | 0.0% | 26.3% | 89.9% |
